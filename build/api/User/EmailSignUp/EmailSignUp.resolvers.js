...
var resolvers = {
    Mutation: {
        EmailSignUp: function (_, args) { return __awaiter(void 0, void 0, void 0, function () {
            var email, existingUser, phoneVerification, newUser, emailVerification, token, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, User_1.default.create(__assign(__assign({}, args), { platform: 'EMAIL' })).save()];
                    case 5:
                        newUser = _a.sent();
