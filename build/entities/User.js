...
var User = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, User_1.hashPassword(this.password)];
                    case 1:
                        _a.password = _b.sent();
                        _b.label = 2;
    ...
    __decorate([
        typeorm_1.Column({ type: 'text', nullable: true, unique: true }),
    ...
    __decorate([
        typeorm_1.Column({ type: 'text', enum: ['KAKAO', 'FACEBOOK', 'EMAIL'] }),
        __metadata("design:type", String)
