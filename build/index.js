...
var appOptions = __assign(__assign({ port: PORT, playground: PLAYGROUND, endpoint: GRAPHQL_ENDPOINT }, process.env.NODE_ENV === 'development' && {
    https: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (user) {
                            return [2 /*return*/, { currentUser: user }];
                        }
                        _a.label = 2;
